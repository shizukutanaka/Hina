...
function renderOut(bd){
  ...
  const txt=(key,mk,ph)=>{ const id='meta-'+mk; bd.append(el('div',{class:'row'},
    ...
    el('input',{id, type:'text', maxlength:'256', autocomplete:'off', value:meta[mk]||'', placeholder:ph||'', oninput:e=>{meta[mk]=e.target.value; saveState();}}))); };
  ...
  bd.append(el('div',{class:'row'},
    ...
    el('input',{id:'meta-title', type:'text', maxlength:'256', autocomplete:'off', value:meta.title||'', placeholder:t('out.title.ph'),
  ...
  licUrlRow.append(
    ...
    el('input',{id:licUrlId, type:'text', maxlength:'256', autocomplete:'off', value:meta.licenseUrl||'',
