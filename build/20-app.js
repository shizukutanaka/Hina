...
function showErr(msg){
  ...
  const sa=$('srAlert'); if(sa){ sa.textContent=''; requestAnimationFrame(()=>{ const a=$('srAlert'); if(a) a.textContent=msg; setTimeout(()=>{ const a2=$('srAlert'); if(a2) a2.textContent=''; },5500); }); }
