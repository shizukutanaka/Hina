...
const openAbout=()=>{ _dlgReturnFocus=document.activeElement; _dlgBg().forEach(el=>{ el.inert=true; }); $('aboutDlg').showModal(); };
...
$('aboutDlg').addEventListener('close',()=>{ _dlgBg().forEach(el=>{ el.inert=false; }); ((_dlgReturnFocus && _dlgReturnFocus.isConnected) ? _dlgReturnFocus : $('btnAbout')).focus(); _dlgReturnFocus=null; });
