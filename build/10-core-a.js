...
const I18N = {
  ja: {
    ...
    'hint.exprOff':'クリックで解除','hint.drag':'ドラッグ/矢印キー: 回転 / Shift+↑↓: パン / ホイール・+−: ズーム / ダブルクリック・Home: リセット','hint.undoReady':'Ctrl+Z → 元に戻す','hint.saved':'✓ 自動保存','hint.sliderReset':'ダブルクリックまたは Delete キーでデフォルト値に戻す',
    ...
    'a11y.exported':'{name} を書き出しました（約{size}）','a11y.screenshotDone':'スクリーンショットを保存しました','a11y.seedCopied':'シード {n} をクリップボードにコピーしました','a11y.gachaRan':'ガチャ — シード {n} で生成しました','a11y.undone':'元に戻しました','a11y.noUndo':'元に戻す履歴がありません','a11y.savedJson':'{name} を保存しました','a11y.clamped':'値を {v} に制限しました','a11y.viewReset':'プレビュー視点をリセットしました',
  ...
  en: {
    ...
    'hint.exprOff':'click to deactivate','hint.drag':'Drag/Arrows: rotate / Shift+↑↓: pan / Wheel · +−: zoom / Double-click · Home: reset','hint.undoReady':'Ctrl+Z → Undo','hint.saved':'✓ Auto-saved','hint.sliderReset':'Double-click or Delete key to reset to default',
    ...
    'a11y.exported':'Exported {name} (~{size})','a11y.screenshotDone':'Screenshot saved','a11y.seedCopied':'Seed {n} copied to clipboard','a11y.gachaRan':'Gacha — generated with seed {n}','a11y.undone':'Undone','a11y.noUndo':'Nothing to undo','a11y.savedJson':'Saved {name}','a11y.clamped':'Value clamped to {v}','a11y.viewReset':'Preview view reset',
