...
const I18N = {
  ja: {
    ...
    'hint.exprOff':'クリックで解除','hint.drag':'ドラッグ/矢印キー: 回転 / Shift+↑↓: パン / ホイール・+−: ズーム / ダブルクリック・Home/0: リセット','hint.undoReady':'Ctrl+Z / ⌘+Z → 元に戻す','hint.saved':'✓ 自動保存','hint.sliderReset':'ダブルクリックまたは Delete キーでデフォルト値に戻す',
    ...
    'a11y.exported':'{name} を書き出しました（約{size}）','a11y.screenshotDone':'スクリーンショットを保存しました','a11y.seedCopied':'シード {n} をクリップボードにコピーしました','a11y.gachaRan':'ガチャ — シード {n} で生成しました','a11y.undone':'元に戻しました','a11y.noUndo':'元に戻す履歴がありません','a11y.savedJson':'{name} を保存しました','a11y.loadedJson':'{name} を読み込みました','a11y.clamped':'値を {v} に制限しました','a11y.viewReset':'プレビュー視点をリセットしました','a11y.seedInvalid':'シードは0以上の整数を入力してください',
  ...
  en: {
    ...
    'hint.exprOff':'click to deactivate','hint.drag':'Drag/Arrows: rotate / Shift+↑↓: pan / Wheel · +−: zoom / Double-click · Home/0: reset','hint.undoReady':'Ctrl+Z / ⌘+Z → Undo','hint.saved':'✓ Auto-saved','hint.sliderReset':'Double-click or Delete key to reset to default',
