...
const I18N = {
  ja: {
    ...
    'hint.exprOff':'クリックで解除','hint.drag':'ドラッグ/矢印キー: 回転 / Shift+↑↓: パン / ホイール・+−: ズーム / ダブルクリック・Home: リセット','hint.undoReady':'Ctrl+Z / ⌘+Z → 元に戻す','hint.saved':'✓ 自動保存','hint.sliderReset':'ダブルクリックまたは Delete キーでデフォルト値に戻す',
  ...
  en: {
    ...
    'hint.exprOff':'click to deactivate','hint.drag':'Drag/Arrows: rotate / Shift+↑↓: pan / Wheel · +−: zoom / Double-click · Home: reset','hint.undoReady':'Ctrl+Z / ⌘+Z → Undo','hint.saved':'✓ Auto-saved','hint.sliderReset':'Double-click or Delete key to reset to default',
