...
const I18N = {
  ja: {
    ...
    'note.upload':'VRChatへは Unity + VRM Converter for VRChat 経由でアップロード。手順は docs/UPLOAD_GUIDE.md 参照。',
  ...
  en: {
    ...
    'note.upload':'Upload to VRChat via Unity + VRM Converter for VRChat. See docs/UPLOAD_GUIDE.md.',
