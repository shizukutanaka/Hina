...
const I18N = {
  ja: {
    ...
    'hint.exprOff':'クリックで解除','hint.drag':'ドラッグ/矢印キー: 回転 / ホイール・+−: ズーム / ダブルクリック・Home: リセット','hint.undoReady':'Ctrl+Z → 元に戻す',
  ...
  en: {
    ...
    'hint.exprOff':'click to deactivate','hint.drag':'Drag/Arrows: rotate / Wheel · +−: zoom / Double-click · Home: reset','hint.undoReady':'Ctrl+Z → Undo',
