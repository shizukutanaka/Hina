...
const I18N = {
  ja: {
    ...
    'a11y.exported':'{name} を書き出しました（約{size}）','a11y.screenshotDone':'スクリーンショットを保存しました',
  ...
  en: {
    ...
    'btn.gacha':'Gacha (randomize)','gacha.seed':'Seed: ','gacha.seed.ph':'Enter seed to replay','btn.copySeed':'Copy','btn.export':'Export VRM','btn.exporting':'Exporting…','btn.exported':'✓ Exported','btn.saveJson':'Save params (.json)','btn.loadJson':'Load params','btn.reset':'Reset','btn.reset.confirm':'Reset to defaults? All changes will be lost.','btn.revert':'↺ Revert to {p}','btn.screenshot':'PNG','btn.screenshot.tip':'Save screenshot (Ctrl+Shift+P)','hint.ctrlS':'Ctrl+S → Export VRM / Ctrl+Shift+S → Save JSON / Ctrl+Z → Undo / Ctrl+Shift+P → PNG / ? → Help / 1-8 → Switch tab',
    ...
    'a11y.exported':'Exported {name} (~{size})','a11y.screenshotDone':'Screenshot saved',
