...
const I18N = {
  ja: {
    ...
    'a11y.exported':'{name} を書き出しました（約{size}）','a11y.screenshotDone':'スクリーンショットを保存しました','a11y.seedCopied':'シード {n} をクリップボードにコピーしました','a11y.undone':'元に戻しました','a11y.noUndo':'元に戻す履歴がありません',
  ...
  en: {
    ...
    'a11y.exported':'Exported {name} (~{size})','a11y.screenshotDone':'Screenshot saved','a11y.seedCopied':'Seed {n} copied to clipboard','a11y.undone':'Undone','a11y.noUndo':'Nothing to undo',
